...
//********* COLOR SCALES **************
// define fund color scales
var fundColors = d3.scale.ordinal()
    .domain(["General Fund", "Non-discretionary funds"])
    .range(['rgb(96,125,167)', 'rgb(227,201,166)']);

// Revenue and Expense color scales
var erColors = d3.scale.ordinal()
    .domain(["expense", "revenue"])
    .range(['rgb(243,184,40)', 'rgb(42,59,103)']);
//********* COLOR SCALES **************


//********* COLOR GRADIENTS **************
// create color gradient for Revenue to General Fund links
...
// create color gradient for Revenue to Non-discretionary fund links
svg.append('linearGradient')
...
// create color gradient for Non-discretionary funds to expenses links
svg.append('linearGradient')
...
// create color gradient for to General Fund to expenses links
svg.append('linearGradient')
...
};//End of do_with_budget function
